<template>
  ...
  <section class="container">
      ...
      >
        <template v-if="product.price<=Number(100)">
          <div class="product-box">
            ...
            <div class="text-box" >
              ...
              <div class="price-badge">
                <span class="badge bg-success" v-if="product.price>=90">premier</span>
                <span class="badge bg-primary" v-else-if="product.price<90 && product.price>10">value</span>
